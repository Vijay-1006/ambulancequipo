...
function submitandGoLive()
{
    if(liveStatus=="inactive")
    {
        ...
        getSharingLiveLocation = setInterval(function(){updatePosition(getLocation()); $.post("driverShare.php", {userID: sessionStorage.getItem("userID"), patientID: $("#patientIDstore").html(), latitude: window.lat, longitude: window.lng});}, 5000);
    }
