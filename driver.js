...
function submitandGoLive()
{
    if(liveStatus=="inactive")
    {
        ...
        getSharingLiveLocation = setInterval(function(){updatePosition(getLocation()); $.post("utilities/startSharing.php", {driverID: sessionStorage.getItem("driverID"), patientID: $("#patientIDstore").html(), latitude: window.lat, longitude: window.lng});}, 5000);
    }
